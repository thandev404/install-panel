...
display_welcome() {
  ...
  echo -e ""
  echo -e "WhatsApp :"
  echo -e "+6285161961107"
  echo -e "Credits :"
  echo -e "Than Developer"
  sleep 4
  clear
}
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY MASKHAN CODE            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "thanganteng" ]; then
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/thandev404/install-panel/raw/main/stellar.zip")        
        break
        ;;
      2)
        THEME_URL=$(echo -e "https://github.com/thandev404/install-panel/raw/main/billing.zip")
        break
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/thandev404/install-panel/raw/main/enigma.zip")
        break
        ;; 
      x)
        return
...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/thandev404/install-panel/raw/main/stellar.zip
